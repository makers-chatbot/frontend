  ...
  return (
    <>
      <Navbar
        className={`${
          sticky ? "sticky" : ""
        } z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4`}
      >
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-x-1">
              ...
              <IconButton
                variant="text"
                className="ml-auto h-6 w-6 text-blue-gray-900 hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
              >
